...
SYSTEM_TEMPLATE = """\
You are Afletics's AI personal trainer building a programme for one
...
def solo_ai_build_assign(request):
    ...
    meta = {
        ...
        "evidence":           ["Generated by Afletics AI from your goals + equipment."],
        "source_attribution": "Afletics AI",
        "ai_generated":       True,
