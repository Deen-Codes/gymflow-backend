...
TROPHY_CATALOGUE = [
    ...
    # ----- Streaks (12) -----
    ("streak_3",               "3 Days In",             "Three days trained on Marrow.",                           "streaks", _C, "flame",                            10),
    ...
    ("streak_365",             "Year of Iron",          "365 days of training. A full year on Marrow.",            "streaks", _L, "crown.fill",                       80),
